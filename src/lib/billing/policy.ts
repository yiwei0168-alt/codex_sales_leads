import { z } from "zod";
import configuration from "../../../config/billing/request-bounds-v1.1.0.json";
...
export const tariffSchema=z.object({
  ...
  requestContract:z.enum(["deepseek-nonthinking-text-v1","kimi-cn-text-json-v1","aliyun-beijing-dense-text-v1"]).optional(),
}).strict();

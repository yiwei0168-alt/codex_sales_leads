import { z } from "zod";
import configuration from "../../../config/billing/request-bounds-v1.3.0.json";
...
export const tariffSchema=z.object({
  ...
  requestContract:z.enum(["deepseek-nonthinking-text-v1","kimi-cn-text-json-v1","aliyun-beijing-dense-text-v1","brave-web-search-v1","tavily-search-v1","exa-company-auto-text-v1"]).optional(),
}).strict();

...
const assessment: LeadCandidateAssessment = {
  ...
  eligibilityStatus: "eligible", cooperationPaths: [{ pathId: "path-distribution",
    pathType: "Direct Distribution", candidateRole: "Distributor", pathNodes: [
      { actor: "Cudy", role: "Brand" }, { actor: "Candidate", role: "Distributor" },
      { actor: "Customer", role: "Downstream channel" }], supplyFlow: "Cudy supplies the distributor.",
    decisionRole: "Candidate manages the vendor portfolio.", fitScore: 82, confidence: 85, rank: 1,
    evidenceIds: ["evidence-example"], prerequisites: [], valuePropositions: ["SMB portfolio"],
    risks: [], unknowns: [], targetTitles: ["Vendor Manager"], recommendedCta: "Discuss portfolio fit.",

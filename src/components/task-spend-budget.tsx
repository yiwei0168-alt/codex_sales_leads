...
type Snapshot={modelUsage?:UsageSummary[];taskLimit:{limit_micros:string;occupied_micros:string}|null;stages:Array<{stage:string;calls:number;reserved_micros:string;reported_micros:string|null;unknown_bills:number;summed_latency_ms:string|null}>};

...
- 用户选中候选公司后，Development Strategy Agent 会结合评分证据、Cudy 混合 RAG、共享模板和当前用户已批准的邮箱风格，生成可审核的开发策略与开发信草稿；批准草稿不会自动发信。
...
7. 在开发助手中由 Kimi-k3 生成策略和草稿，人工编辑并批准；批准状态仅为未来受控发信接口预留。

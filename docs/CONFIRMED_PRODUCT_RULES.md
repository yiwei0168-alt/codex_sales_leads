...
### KQ01 — 知识问答与资料访问按通用问题分阶段优化（2026-09-17，用户明确范围与实施授权；P0–P6已实施，P7–P8待后续）
...
已形成[通用知识优化实施交接计划](KNOWLEDGE_RETRIEVAL_OPTIMIZATION_PLAN_2026-09-17.md)，包含跨语料只读统计、事实提取/切片反例、P0–P8步骤、文件路径、验收与回退要求。P0–P4已依次完成冻结评测、证据边界、受控原件、结构化影子代和 verified 事实合同。P5 已将资料打开、事实直答和复杂解释接入同一个可展开 `knowledge_workflow`。P6 已使 null-vector/关键词/结构化候选在 ACL 后独立参与召回，加入受控同义词与相关证据窗口，详见[P6证据](KNOWLEDGE_RETRIEVAL_P6_EVIDENCE_2026-09-17.md)。历史事实未删除、影子代未激活，不能宣称全库已纠正。计划默认保留 C14 的轻量意图识别；完全本地优先意图的例外尚未确认。P7–P8及真实性能目标仍须验收。A30/A33/A34及LG02/LG04/LG05继续有效。

...
### KQ01 — 知识问答与资料访问按通用问题分阶段优化（2026-09-17，用户明确范围与实施授权；P0–P5已实施，P6–P8待后续）
...
已形成[通用知识优化实施交接计划](KNOWLEDGE_RETRIEVAL_OPTIMIZATION_PLAN_2026-09-17.md)，包含跨语料只读统计、事实提取/切片反例、P0–P8步骤、文件路径、验收与回退要求。P0–P4已依次完成冻结评测、证据边界、受控原件、结构化影子代和 verified 事实合同。P5 已将资料打开、事实直答和复杂解释接入同一个可展开 `knowledge_workflow`，助手与知识页共用它；资料/事实成功路径省略 embedding 与回答生成，详见[P5证据](KNOWLEDGE_RETRIEVAL_P5_EVIDENCE_2026-09-17.md)。历史事实未删除、影子代未激活，不能宣称全库已纠正。计划默认保留 C14 的轻量意图识别；完全本地优先意图的例外尚未确认。P6–P8及其性能目标仍须各阶段验收。A30/A33/A34及LG02/LG04/LG05继续有效。

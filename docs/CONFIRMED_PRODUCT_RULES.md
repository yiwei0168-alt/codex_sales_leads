...
版本：1.8.0。整理日期：2026-09-13。来源：本项目用户确认记录及仓库文档。
...
固定提示审核：[P01/P02 已确认及 P03–P06 待确认方案](FIXED_PROMPT_CACHE_REVIEW_2026-09-13.md)。区分本地结果缓存、服务商前缀缓存和规则投影压缩三种收益。下一项讨论 P03 模型规则投影的具体保留/排除边界；B20/B21 不代表代码已实施。

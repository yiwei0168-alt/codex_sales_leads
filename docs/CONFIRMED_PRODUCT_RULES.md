...
### KQ01 — 知识问答与资料访问按通用问题分阶段优化（2026-09-17，用户明确范围与实施授权；P0–P4已实施，P5–P8待后续）
...
已形成[通用知识优化实施交接计划](KNOWLEDGE_RETRIEVAL_OPTIMIZATION_PLAN_2026-09-17.md)，包含跨语料只读统计、事实提取/切片反例、P0–P8步骤、文件路径、验收与回退要求。P0已建立200条确定性离线评测请求、只读语料审计和缺陷基线，详见[P0证据](KNOWLEDGE_RETRIEVAL_P0_BASELINE_2026-09-17.md)。P1已通用修复四类抽取边界、严格验证引用/冲突/型号，并只读登记64条旧事实候选，详见[P1证据](KNOWLEDGE_RETRIEVAL_P1_EVIDENCE_2026-09-17.md)。P2已登记281个现有原件关系、实体多对多关系和受控文件接口，详见[P2证据](KNOWLEDGE_RETRIEVAL_P2_EVIDENCE_2026-09-17.md)；历史事实未删除、未重嵌入，不能宣称全库已纠正。计划默认保留 C14 的轻量意图识别，仅在识别后为明确资料/事实查询省略不必要的embedding及回答生成；完全本地优先意图的例外尚未确认。P3–P8及其性能目标仍须各阶段验收。A30/A33/A34及LG02/LG04/LG05继续有效。

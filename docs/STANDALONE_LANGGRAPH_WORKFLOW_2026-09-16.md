...
P0–P7已建立评测、证据校验、受控原件、结构化影子代、事实合同、共享图、混合检索修复及版本绑定缓存/遥测/回退命令。P3 影子代仍未激活，P7 dry-run 显示 10,871 个向量仍需付费重建且费用未知。[P7证据](KNOWLEDGE_RETRIEVAL_P7_EVIDENCE_2026-09-17.md)。

...
P0现已增加只读语料审计与默认离线的200条评测基线；P1已收紧事实抽取、证据关联和 grounded 判定；P2已建立受控原件与实体关系。三个阶段都未改变任何LangGraph节点或注册图，当前图拓扑仍以LG04验收结果为准；知识子图从P5开始实施。[P0证据](KNOWLEDGE_RETRIEVAL_P0_BASELINE_2026-09-17.md)、[P1证据](KNOWLEDGE_RETRIEVAL_P1_EVIDENCE_2026-09-17.md)、[P2证据](KNOWLEDGE_RETRIEVAL_P2_EVIDENCE_2026-09-17.md)。

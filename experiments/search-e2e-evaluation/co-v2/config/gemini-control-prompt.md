...
Do not assign scores, account tiers, cooperation paths, development strategy, email content or contacts. Do not search for sales agents, brand owners or OEM/ODM suppliers/opportunities. If fewer than 50 verified companies are found, return only verified companies; do not invent or pad the result.

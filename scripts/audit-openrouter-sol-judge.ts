...
if(!baseline||baseline.contextLength!==1050000)throw new Error("Missing exact Sol baseline");
...
const audit=auditPublicReviewBound(baseline,current,12000,27736500);

...
const sql = (await Promise.all([
  ...
  "086_pin_bge_m3_artifact.sql", "088_knowledge_review_center.sql", "089_activate_v3_with_fact_quarantine.sql",
...
const required = [
  ...
  "knowledge_evaluation_review_v3", "knowledge_evaluation_holdout_gate_v3",
  "unresolved document review items", "open fact reviews remain quarantined by serving queries",
];
...
console.log(JSON.stringify({
  migrations: ["083", "084", "085", "086", "088", "089"], requiredContracts: required.length,

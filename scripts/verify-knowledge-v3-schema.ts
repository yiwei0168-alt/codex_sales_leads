...
const sql = (await Promise.all([
  ...
  "086_pin_bge_m3_artifact.sql", "088_knowledge_review_center.sql",
...
const required = [
  ...
  "v3 release requires 300 reviewed gold cases", "knowledge_release_v3_gold_activation_guard",
];
...
console.log(JSON.stringify({
  migrations: ["083", "084", "085", "086", "088"], requiredContracts: required.length,
